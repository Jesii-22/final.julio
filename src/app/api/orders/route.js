  ...
  async function reserveProductStock(
    ...
    try {
      for (const [
        ...
        /*
          Solo descuenta si todavía existe
          suficiente stock.
        */
      ...
      /*
        Si falló uno de los productos,
        devolvemos el stock que ya se había
        descontado de los anteriores.
      */
      try {
...
export async function POST(request) {
  try {
    ...
    if (
      ...
      throw requestError(
        "Uno o más productos del carrito son inválidos."
      );
    }
    ...
    const total = Math.max(
      ...
      /*
        Reservamos el stock antes de generar
      ...
      try {
        ...
        */
        try {
          ...
          console.error(
            "Error al restaurar el stock de una orden fallida:",
            restoreError
          );
        }
